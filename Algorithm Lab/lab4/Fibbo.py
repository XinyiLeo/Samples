class FibHeap:
    ...
    def print_node(self,a):
        ini = a;
        if a == self.root_list:
            print('The first line are: ', end = ' ')
        else:
            print()
            print('The children of ' + str(a.parent.data) + ' are: ')
        while a.right!=ini:
            print(str(a.data) + '('+ str(a.degree) + ')(' + str(a.left.data) + ')' ,end = ' ')
            if a.child != None:
                prev_node = a.left
                self.print_node(a.child)
            a = a.right
        print(str(a.data) + '(' + str(a.degree) + ')(' + str(a.left.data) + ')')
        if a.child != None:
            prev_node = a.left
            self.print_node(a.child)
